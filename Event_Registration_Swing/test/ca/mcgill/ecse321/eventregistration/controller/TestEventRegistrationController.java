...
import ca.mcgill.ecse321.eventregistration.controller.*;
...
public class TestEventRegistrationController {
	...
	public void testCreateEvent() {
		RegistrationManager rManager = new RegistrationManager();
	...
	public void testCreateEventNull() {
		...
		try {
			...
			errorString = iie.getMessage();
		}
		String msgString = "Event name cannot be empty! Event date cannot be empty! Event start time cannot be empty! Event end time cannot be empty!";
		assertEquals(msgString, errorString);
		assertEquals(0, rm.getEvents().size());
	}
	...
	public void testCreateEventEmpty() {
		...
		EventRegistrationController erc = new EventRegistrationController(rm);
		try {
			erc.createEvent(nameString, eventDate, startTime, endTime);
		} catch (InvalidInputException e) {
			// TODO: handle exception
			errorString = e.getMessage();
		}
		assertEquals("Event name cannot be empty!", errorString);
		assertEquals(0, rm.getEvents().size());
